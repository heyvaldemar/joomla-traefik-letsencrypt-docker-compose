...
- **`joomla:6.1.3` was rebuilt upstream**; the pin moved from `sha256:686889e1f355…` to `sha256:6ccc90fc7d03…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **`joomla:6.1.3` was rebuilt upstream**; the pin moved from `sha256:ea06bedd0b35…` to `sha256:1da83a6a5505…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
- **`joomla:6.1.3` was rebuilt upstream**; the pin moved from `sha256:b7805107b9fc…` to `sha256:ea06bedd0b35…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.

## [1.8.2] - 2026-09-16

### Security

- **`joomla:6.1.3` was rebuilt upstream**; the pin moved from `sha256:bbf24ad7d21d…` to `sha256:b7805107b9fc…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
...
[Unreleased]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.9.0...HEAD
[1.9.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.8.8...v1.9.0
[1.8.6]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.8.5...v1.8.6
...
[1.8.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.7.0...v1.8.0
[1.7.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.6.0...v1.7.0
[1.6.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.5.0...v1.6.0
[1.5.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.4.0...v1.5.0
[1.4.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.3.0...v1.4.0
[1.3.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.2.0...v1.3.0
[1.2.0]: https://github.com/heyvaldemar/joomla-traefik-letsencrypt-docker-compose/compare/v1.1.0...v1.2.0
